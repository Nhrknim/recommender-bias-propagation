...
1. [**recommender_models.md**](./recommender_models.md)
...
2. [**bias_propagation_and_embedding_dynamics.md**](./bias_propagation_and_embedding_dynamics.md)
...
3. [**phase1_data_prep.md**](./phase1_data_prep.md)
...
4. [**phase2_cornac_models.md**](./phase2_cornac_models.md)
